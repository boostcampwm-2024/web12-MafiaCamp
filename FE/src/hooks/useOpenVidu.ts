...
type Action =
  ...
  | { type: 'ELIMINATE_SUBSCRIBER'; payload: { nickname: string } };
...
export const useOpenVidu = () => {
  ...
  const eliminateSubscriber = (nickname: string) => {
    dispatch({ type: 'ELIMINATE_SUBSCRIBER', payload: { nickname } });
  };
